...
class Post(models.Model):
    ...
    is_top = models.BooleanField(default=False, verbose_name=u'置顶文章')  # 文章是否置顶，默认不置顶
...
class SidebarMusic(models.Model):
    ...
    # 播放歌单id，获取方法自行百度，比如我的id就是链接后面的id，https://music.163.com/#/playlist?id=6754450319
