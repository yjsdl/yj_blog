# Generated by Django 3.0.8 on 2021-03-01 13:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('server',
                 models.CharField(choices=[('netease', '网易云音乐'), ('tencent', 'QQ音乐'), ('xiami', '虾米'), ('kugou', '酷狗')],
                                  default='netease', max_length=20, unique=True, verbose_name='平台')),
                ('type',
                 models.CharField(choices=[('song', '单曲'), ('album', '专辑'), ('playlist', '歌单'), ('search', '搜索')],
                                  default='playlist', max_length=20, verbose_name='类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(
                    choices=[('sitename', '站点名称'), ('sitetitle', '站点标题'), ('email', '我的邮箱'), ('weibo', '微博主页'),
                             ('music', '我的音乐主页'), ('twitter', 'Twitter'), ('github', 'GitHub'), ('beian', '备案号'),
                             ('baidu_tj', '百度统计代码')], max_length=20, unique=True, verbose_name='名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_type',
                 models.CharField(choices=[('post', '博客文章'), ('about', '关于本站'), ('project', '我的项目')], default='post',
                ...
                ('tutorial', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               to='blog.Tutorial', verbose_name='教程')),
            ],
            options={
                'verbose_name': '博客文章',
