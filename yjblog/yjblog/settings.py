...
WSGI_APPLICATION = 'yjblog.wsgi.application'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = 'yj160521@163.com'  # 邮箱帐号：用于发送邮件的账号
EMAIL_HOST_PASSWORD = '131520bb'        # 邮箱密码：用于发送邮件的账号密码
DEFAULT_FROM_EMAIL = 'yj<yj160521@163.com>'   # 发件人，邮件头部显示
